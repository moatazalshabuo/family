                                        ...
                                        <div class="row text-right">
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="surename" type="text"
                                                        ...
                                                        name="surename" value="{{ old('surename') }}" required
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="Specialization" value="{{ old('Specialization') }}"
                                                        name="Specialization"
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="type" name="type"
                                                        ...
                                                        @endif
                                                        <option @selected(old('type') == '3') value="3">مستخدم عادي</option>
                                                    </select>
                                                    @error('marital_status')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    <label>موظف</label>
                                                    <input type="radio" @checked(old('is_work') == 1) name="is_work"
                                                        value="1">
                                                    <label>عاطل</label>
                                                    <input type="radio" @checked(old('is_work') == 0) name="is_work"
                                                        value="0">
                                                    @error('is_work')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="radio" checked name="life" value="1">
                                                    <label>متوفي</label>
                                                    <input type="radio" name="life" value="0">
                                                    @error('life')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
