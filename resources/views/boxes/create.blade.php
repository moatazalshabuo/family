                                        ...
                                        <div class="row text-right">
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    <label for="name_box" class="">عنوان الصندوق</label>
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    <label for="name_box" class="">نوع الصندوق</label>
                                                    <select class="form-control" name="type_box" required>
                                                        <option value="">اختيار نوع الصندوق</option>
                                                        <option value="0">لمرة واحدة</option>
                                                        <option value="1">يتكرر شهريا</option>
                                                    </select>
                                                    @error('type_box')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    ...
                                                    <label>لكل فرد</label>
                                                    <input type="radio" name="for" checked value="1">
                                                    <label>الاجمالي</label>
                                                    <input type="radio" name="for" value="0">
                                                    @error('value')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
